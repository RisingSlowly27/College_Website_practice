  ...
  return (
    <Layout>
      <section className="relative overflow-hidden bg-cream">
        <div className="relative mx-auto aspect-[16/9] max-h-[620px] w-full sm:aspect-[2/1] lg:aspect-[231/130]">
          <img
          ...
          <div className="absolute inset-0 flex items-center px-4 sm:px-8 lg:px-[168px]">
            <h1 className="max-w-[647px] text-3xl font-bold leading-tight text-brand drop-shadow-[0_2px_8px_rgba(255,255,255,0.6)] sm:text-5xl lg:text-[64px] lg:leading-[74px]">
              Computer Science and Technology
            </h1>
          </div>

          <div className="absolute right-0 top-1/3 hidden -translate-y-1/2 lg:flex">
      ...
      <div className="mx-auto flex max-w-[1720px] flex-col gap-10 px-4 py-10 sm:px-6 lg:flex-row lg:gap-14 lg:px-10 lg:py-16">
        <Sidebar />
